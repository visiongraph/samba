          ...
          <div id="content">
            <div class="post clearfix post-146 skt_menu_items type-skt_menu_items status-publish has-post-thumbnail hentry menu_item_category-dessert" id="post-146" >
              <div class="featured-image-shadow-box blog-menu-items span12" style="text-align:justify; font-size:14px;">
                ...
                <img src="images/classes/classes1.jpg">
                </div>
                
                <div class="span8" >
              <h5 class="titulos" > 
              <br>
              <br>Best Classes of New York</h5>
              ...
              <div class="skepost clearfix">
                <p>  <br>
              <br>Samba New York! functions behind the scenes as New York City's premier training ground for samba drummers, having graduated numerous players who have gone on to form their own organizations that have enriched the local Brazilian music scene. Our music courses taught by Samba New York! Director Philip Galinsky, Ph.D. provide exceptional training in the art of samba rhythms, song, and culture in a supportive learning environment. We also offer private lessons in samba percussion for those seeking quicker progress. </p>
                <br>
              <br>
                        <br>
                 ...
                 <a  href="#"> <div id="circle4" class="fade_in_hide element_fade_in menu-meta-center"><br><br>Take a Class <br> > Here <</div>
              </div>
              <!-- skepost --></div>
          </div>
        ...
        <div id="container" class="span12">
          <div id="content">
            <div class="post clearfix post-146 skt_menu_items type-skt_menu_items status-publish has-post-thumbnail hentry menu_item_category-dessert" id="post-146" >
                ...
                <div class="clearfix centrado">
                  <div class=" menu-meta-center">
                    <div class="titulos"><br>
                     Some of the benefits of our classes include:<br><br>
                      <br>
                    </div>
                  </div>
                </div>
              ...
              <div class="skepost clearfix">
                <p><strong>Socializing:</strong> Join a fun and inclusive community of Brazilian music enthusiasts.<br><br><br>
                  <strong>Performing for fun:</strong> Become a member of our Bateria — a high-energy drum and percussion ensemble that animates many of the City's most exciting parades and events.<br><br><br>
                  <strong>Professional opportunities:</strong> Participate in a rigorous percussion-training program and audition to become a member of our professional Show Group.<br><br><br>
 </p><br><br><br><br><br>
              </div>
              <!-- skepost --></div>
