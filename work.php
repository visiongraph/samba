...
<body class="page page-id-29 page-template page-template-template-menu-items-fullwidth page-template-template-menu-items-fullwidth-php" style="background: url(images/home/fondodrsamba.jpg); background-attachment:fixed;">
<?php include 'topclasses.php';?>
          ...
          <div id="content">
            <div class="post clearfix post-146 skt_menu_items type-skt_menu_items status-publish has-post-thumbnail hentry menu_item_category-dessert" id="post-146" >
              <div class="featured-image-shadow-box blog-menu-items span12" style="text-align:justify; font-size:14px;">
                ...
                <img src="images/academy/workshop.jpg">
                </div>
              ...
              <br>
              <br>
              We Make Workshops all over the World</h5>
              <div class="skepost-meta clearfix">
                <div class="menu-meta-left"> </div>
              </div>
              <!-- skepost-meta -->
              
              <div class="skepost clearfix">
                <p>  <br>
              <br>Samba New York! can bring the same knowledge and experience that we use to train our own musicians and dancers to your organization! Known as “Dr. Samba” for his rare combination of practical and academic expertise in Brazilian music, Philip Galinsky, Ph.D. — Director of Samba New York! and a leading specialist in Brazilian music in the field of ethnomusicology — is one of the most respected and influential educators of samba drumming in the US. Over the last two decades, he has developed a unique teaching method that has enabled countless students of all musical backgrounds to understand samba analytically and to play it at a high level with the proper Brazilian feel.<br>
<br>


Having successfully tested this methodology in Samba New York! and by conducting workshops at numerous institutions since 1994, Dr. Samba has just the right set of skills to take your group, whether composed of complete beginners or professionals, to the next level of proficiency in samba music performance. 
 </p>
              ...
              <br>
                 ...
                 <a  href="#"> <div id="circle4" class="fade_in_hide element_fade_in menu-meta-center"><br><br>Book a Workshop<br> > Here <</div><br><br>
              </div>
              <!-- skepost --></div>
          </div>
          <span class="skepost clearfix"></span>
    ...
    <!-- container --> 
       <div class="workshop">
        ...
        <div class="container post-wrap" style=" padding:20px 20px 0px 20px;" >
      <div class="row-fluid">
        <div id="container" class="span12">
          <div id="content">
            <div class="post clearfix post-146 skt_menu_items type-skt_menu_items status-publish has-post-thumbnail hentry menu_item_category-dessert" id="post-146" >
              <div class="featured-image-shadow-box blog-menu-items span12" style="text-align:justify;">
                <div class="clearfix centrado">
                  <div class=" menu-meta-center">
                    <div class="titulos"><br>
                    Topics for workshops, master classes, and residencies with Dr. Samba can include:<br><br>
                      <br>
                    </div>
                  </div>
                </div>
              ...
              <div class="skepost clearfix">
                <p>	<strong>Bateria Basics: </strong>Basic techniques and patterns on each instrument; the Rhythmic Structure of Samba; how to achieve the samba “swing”; standard hand signals and conventions of the typical samba-enredo song form<br><br>
	<strong>Get Your Groove On: </strong>Concentrated work on technique, timing, swing, and synchronization in service of achieving an optional groove in your Bateria<br><br>
	<strong>Tectionals: </strong>An in-depth exploration of one or more instruments in the Bateria (covers both techniques and rehearsing for optimal blend)<br><br>
	<strong>Bateria Leadership: </strong>Methodologies for effective directing, including formation of the Bateria, tuning, conducting techniques, organizational strategies, and people management skills <br><br>
	<strong>Bateria Styles: </strong>A survey of some of the most distinctive samba school styles from Rio and/or other Brazilian rhythms adapted to the Bateria<br><br>
	<strong>Original Sound: </strong>Create your very own Bateria style and arrangements<br><br>
	<strong>Roots Rhythms: </strong>Learn to play basic patterns and variations on pagode percussion instruments and to sing selected samba repertory<br><br>

              </div>
              <!-- skepost --></div>
               <div class= " span5" > <strong>Here one of our classes<br>
                 <br>
</strong> <iframe  src="https://www.youtube.com/embed/laKFZOE_5Pw"  height="300" frameborder="0" allowfullscreen></iframe></div>
          </div>
          <span class="skepost clearfix"></span>
