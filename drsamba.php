          ...
          <div id="content">
            <div class="post clearfix post-146 skt_menu_items type-skt_menu_items status-publish has-post-thumbnail hentry menu_item_category-dessert" id="post-146">
              <div class="featured-image-shadow-box blog-menu-items span12" style="text-align:justify; font-size:14px;"> 
                ...
                <div class="skepost-meta clearfix centrado ">
                  <div class="menu-meta-left"><div><br> <h1 class="post-title"><i class="fa fa-user-secret"></i> Dr. Samba</h1><br>
          </div>
                  </div>
                </div>
              </div>
            ...
            <div class="post clearfix post-144 skt_menu_items type-skt_menu_items status-publish has-post-thumbnail hentry menu_item_category-russian" id="post-144">
              <div class="featured-image-shadow-box blog-menu-items span4"> 
                <!-- normal -->
                <div class="fade_in_hide element_fade_in"> <a href="#"><span class="img"><img class="skin-border" src="images/about/drsamba2.png" alt="Menu Thumbnail" /></span> <span class="info"> <span class="skt-info-back"> <span class="skt-external-link"></span>
                  <h3></h3>
                  </span> </span> </a> </div>
                <!-- end normal --> 
              </div>
              <div class="span8 fade_in_hide element_fade_in">
                ...
                <div class="skepost clearfix">
                  <p>Since 1994, he has taught hundreds of people of all musical backgrounds to play samba. Many of his students have gone on to become leaders of their own groups, including Phillybloco, Unidos da Filadelfia, Harlem Samba, Mais Um, and Batala NYC. Since 2003, he has emerged as the top samba percussion instructor in New York City, offering regular courses for students of all levels through Samba New York!<br>
<br>


Known as “Dr. Samba” for his rare combination of academic and practical expertise in Brazilian music, he has conducted workshops and master classes and held residencies in samba at numerous institutions, including NYU, City University of New York Graduate Center, Stony Brook University, Drummers Collective, Frederick Douglass Academy, the University of Southern Maine, Bates College, Colby College, the University of Michigan (through the Brazil Initiative of the Center for Latin American and Caribbean Studies), California Brazil Camp, and Evanston Escola de Samba (Evanston, IL), among many others.<br>
<br>


He is available as an educator and specialist in Brazilian percussion for workshops, residencies, lecture-demonstrations, private instruction, live performances, and recordings.
<br>
<br>

Philip Galinsky is honored to be an endorser of Latin Percussion.
