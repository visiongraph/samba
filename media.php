   ...
   <div class="span4" style="margin:0px;">
	...
	<script type="text/javascript">
		...
		$('.examples1 a').simpleLightboxVideo();
                ...
                <iframe height="300" src="https://www.youtube.com/embed/Aj-pvRs8eBY" frameborder="0" allowfullscreen></iframe>
<p>Resume<br>
                </p>
                </div>
                <!-- skepost --></div>
	...
	<script type="text/javascript">
		...
		$('.examples1 a').simpleLightboxVideo();
                ...
                <div class="skepost clearfix"> <iframe height="300" src="https://www.youtube.com/embed/Aj-pvRs8eBY" frameborder="0" allowfullscreen></iframe>
                  <p>Resume<br>
                  </p>
                </div>
                <!-- skepost --></div>
