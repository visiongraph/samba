...
<?php include 'topmedia.php';?>
  <div class="container post-wrap" style="background:#FFF; padding:20px;" >
            ...
            <div class="featured-image-shadow-box blog-menu-items span12" style="text-align:justify; font-size:14px;">
              <div class="skepost-meta clearfix centrado">
                <div class="menu-meta-left">
                  <div><br>
                    <h1 class="post-title"><i class="fa fa-video-camera"></i> Videos</h1>
                    <br>
                  </div>
                </div>
              </div>
   ...
   <div class="span4" style="margin:0px;">
                 <h2 > Batucada at Manhattan's One Penn Plaza</h2>
                <div class="skepost-meta clearfix">
                  <div class="menu-meta-left"> 
                                           
	   <div class="examples1">
	
			<i class="fa fa-video-camera" ></i> Sep 15, 2015 
		<br>
                ...
                <iframe height="300" src="https://www.youtube.com/embed/eulwJIdAryI" frameborder="0" allowfullscreen></iframe>
<p>A portion of Samba New York's Bateria (Drum Section) playing samba groove and an original break in the heart of NYC.<br>
                </p>
                </div>
                <!-- skepost --></div>
            <div class="span4">
             <h2 >Queen of the Drums" Contest 2015</h2>
                <div class="skepost-meta clearfix">
                  <div class="menu-meta-left"> 
                                           
	   <div class="examples2">
		
			<i class="fa fa-video-camera" ></i> May 5, 2015 
		<br>
                ...
                <div class="skepost clearfix"> <iframe height="300" src="https://www.youtube.com/embed/XwoX7KYSAVc" frameborder="0" allowfullscreen></iframe>
                  <p>MC Antonio Carlos announces Samba New York's "Queen" and "Princesses" of the Drums 2015 at the Samba Party at DROM in New York City on Sunday, May 3rd, 2015! <br>
                  </p>
                </div>
                <!-- skepost --></div>
                <div class="span4">
	   ...
	   <div class="examples2">
			...
			<i class="fa fa-video-camera" ></i> Sep 7, 2015
		<br>
                ...
                <div class="skepost clearfix">     <iframe height="300" src="https://www.youtube.com/embed/rXjlrftkxFc" frameborder="0" allowfullscreen></iframe>
                  <p>The Samba New York! Bateria (Drum Section) at our Brazil Independence Day Samba Party at DROM on September 5th, 2015.<br>
                  </p>
                </div>
                <!-- skepost --></div>
            ...
            <div class="span4" style="margin:0px;">
           <h2 >Brazil Independence Day Samba Party </h2>
                <div class="skepost-meta clearfix">
                  <div class="menu-meta-left"> 
                                           
	   <div class="examples1">
		
			<i class="fa fa-video-camera" ></i> Sep 5, 2015 
		<br>
                ...
                <div class="skepost clearfix">
                <iframe height="300" src="https://www.youtube.com/embed/I3GUvj7nhxc" frameborder="0" allowfullscreen></iframe>
<p>In the heart of the Samba New York! Bateria (Drum Section).<br>
                </p>
                </div>
                <!-- skepost --></div>
            <div class="span4">
                <h2 >The Excitement of Rio Carnaval!</h2>
                <div class="skepost-meta clearfix">
                  <div class="menu-meta-left"> 
                                           
	   <div class="examples2">
		
			<i class="fa fa-video-camera" ></i> Aug 27, 2015 
		<br>
                ...
                <div class="skepost clearfix"> <iframe height="300" src="https://www.youtube.com/embed/QAttj6AlTBg" frameborder="0" allowfullscreen></iframe>
                  <p>Video by David Seeger of Today Video with assistance from Rob Barrett of Time Machine Film Works. NYC's premier samba performance company takes you on a journey through the exhilarating sounds and colors of samba — Brazil's most celebrated music and dance.<br>
                  </p>
                </div>
                <!-- skepost --></div>
                <div class="span4">
                <h2 >Samba New York's "Samba Party"</h2>
                <div class="skepost-meta clearfix">
                  <div class="menu-meta-left"> 
                                           
	   <div class="examples2">
		
			<i class="fa fa-video-camera" ></i> Jun 3, 2014 
		<br>
                ...
                <div class="skepost clearfix">     <iframe height="300" src="https://www.youtube.com/embed/WxzRN9IKTlU" frameborder="0" allowfullscreen></iframe>
                  <p>Samba New York! hosts a pioneering pagode samba gathering at DROM during its April 26th, 2014 Samba Party. Featuring Ana Fernandez on vocals. Playing Grupo Fundo de Quintal's "Nosso Grito" (André Renato/Sereno/Riquinho). Video by Rick Morris.<br>
                  </p>
                </div>
                <!-- skepost --></div>
