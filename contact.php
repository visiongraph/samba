        ...
        <div id="container" class="span12">
          <div id="content">
            <div class="post clearfix post-146 skt_menu_items type-skt_menu_items status-publish has-post-thumbnail hentry menu_item_category-dessert" id="post-146" >
              <div class="featured-image-shadow-box blog-menu-items span12" style="text-align:justify; font-size:14px;">
                <div class="skepost-meta clearfix centrado">
                  <div class="menu-meta-left">
                    <div><br>
                      <h1 class="post-title"><i class="fa fa-envelope"></i> Contact Us</h1>
                      <br>
                    </div>
                  </div>
                </div>
              ...
              <form method="post" action="contact.php" data-jkit="[form:validateonly=true]" id="formulario">
					<div class="contact-one">
						<p>
							<label for="nombre" style="font-size:16px;">Nombre:</label><br />
							<input class="" style="border-radius: 4px;" name="nombre" id="nombre" data-jkit="[validate:required=true;min=3;max=50;error=Por favor escriba su nombre]">
						</p>
					</div>  

					<div class="contact-two">  
						<p>
							<label for="email" style="font-size:16px;">E-mail:</label><br />
							<input  name="email" id="email" data-jkit="[validate:required=true;strength=50;error=Escriba un e-mail valido]">
						</p>
					</div>  
<div class="contact-four">  
						<p>
							<label for="email" style="font-size:16px;">Select:</label><br />
							<select>
							  <option value="contact">Contact</option>
							  <option value="class">Want a Class</option>
							  <option value="work">Book a Workclass</option>
					...
					<div class="contact-three">  
						<p>
							<label style="font-size:16px;">Mensaje:</label><br />
							<textarea style="border-radius: 8px;" id="mensaje" name="mensaje"></textarea><br/><br/>
							<input class="button-submit" name="send" type="submit" value="Send" />
						</p>
					</div>     
					<div class="contact-one">
					<br/><br/><br/><br/>
