    ...
    <div class="container post-wrap">
      <div class="row-fluid">
        <div id="container" class="span12">
         ...
         <div class="centrado">      
        <img src="images/about/iconsamba.png" width="206" height="171"><br> <h1 class="post-title">Samba New York!</h1>
        <p>&nbsp;</p>   </div>
 Samba New York! is a family-run company led by a husband-and-wife team committed to cultural, artistic, and business integrity and to providing extraordinary service to its clients and students.<br>
<br>


The company began with a dream that percussionist and ethnomusicologist Philip Galinsky had in 2002 that he was directing a samba percussion ensemble — a bateria — that was so enormous that he couldn’t see where the lines of drummers started or ended. Already a specialist in Brazilian music, Philip brought this inspiring idea to his wife, Valerie Galinsky, and the rest is history. The two began to design the company’s first logo; Philip began teaching samba percussion classes in New York; and the group had its debut performance at the Live Lunch series at The Grace Plaza in Manhattan on June 17, 2003. Many years later, Samba New York! has helped to change the culture in New York City and beyond with first-rate classes, workshops, and shows that enrich, educate, inspire, and uplift countless people of all backgrounds with the joyful music and dance of Brazil.
            ...
            <div class="post clearfix post-144 skt_menu_items type-skt_menu_items status-publish has-post-thumbnail hentry menu_item_category-russian" id="post-144">
              <div class="featured-image-shadow-box blog-menu-items span8"> 
                <!-- normal -->
                <div class="ih-item square effect6 from_top_and_bottom"> <a href="#"><span class="img"><img class="skin-border" src="images/about/teamleaders.png" alt="Menu Thumbnail" /></span> <span class="info"> <span class="skt-info-back"> <span class="skt-external-link"></span>
                  <h3>Ricotta Pie</h3>
                  </span> </span> </a> </div>
                <!-- end normal --> 
              </div>
              <div class="span4">
                <h1 class="post-title"><a href="#" title="Ricotta Pie">Teams Leadears</a></h1>
                <div class="skepost-meta clearfix">
                  <div class="menu-meta-left"> <span class="author-post-rating-stars"> <span class="no-rate"></span> </span><!-- rating --> 
                  </div>
                </div>
                <!-- skepost-meta -->
                ...
                <!-- skepost -->
                <div class="continue"><a href="team.php">Read More</a></div>
              </div>
              <!-- span4 --> 
            ...
            <div class="post clearfix post-104 skt_menu_items type-skt_menu_items status-publish has-post-thumbnail hentry menu_item_category-russian" id="post-104">
              <div class="featured-image-shadow-box blog-menu-items span8"> 
                <!-- normal -->
                <div class="ih-item square effect6 from_top_and_bottom"> <a href="#"><span class="img"><img class="skin-border" src="images/about/drsamba.png" alt="Menu Thumbnail" /></span> <span class="info"> <span class="skt-info-back"> <span class="skt-external-link"></span>
                  <h3>Donec vestibulum</h3>
                  </span> </span> </a> </div>
                <!-- end normal --> 
              </div>
              <div class="span4">
                <h1 class="post-title"><a href="#" title="Donec vestibulum">Dr. Samba</a></h1>
                <div class="skepost-meta clearfix">
                  <div class="menu-meta-left"> <span class="author-post-rating-stars"> <span class="no-rate"></span> </span><!-- rating --> 
                  </div>
                ...
                <!-- skepost -->
                <div class="continue"><a href="drsamba.php">Read More</a></div>
              </div>
              <!-- span4 --> 
