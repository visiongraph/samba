        ...
        <div id="container" class="span12">
          <div id="content">
            <div class="post clearfix post-146 skt_menu_items type-skt_menu_items status-publish has-post-thumbnail hentry menu_item_category-dessert" id="post-146" >
              <div class="featured-image-shadow-box blog-menu-items span12" style="text-align:justify; font-size:14px;">
                <div class="skepost-meta clearfix centrado">
                  <div class="menu-meta-left">
                    <div><br>
                      <h1 class="post-title"><i class="fa fa-newspaper-o"></i> News</h1>
                      <br>
                    </div>
                  </div>
                </div>
              ...
              <h5 class="titulos" > 
            SAMBA NEW YORK! IN MARTINIQUE</h5>
              <div class="clearfix">
              ...
              <div class="span7" >
                ...
                <div class="skepost clearfix">
                  <p>In December 2015, Samba New York’s Director, Philip Galinsky, Ph.D. gave a series of pioneering workshops in Brazilian percussion on the Caribbean island of Martinique in the French West Indies, covering both samba and samba-reggae styles. Manager Valerie Galinsky, who is originally from Martinique, assisted. The workshops may have been the first of their kind in Martinique and were co-sponsored by the local organizations MJC Floreal, Batala Madinina, and Association Alegria. Samba New York! is planning another trip to the island in April of 2016 to offer more workshops and shows. Take a look at our interview below on Martinique Premiere TV, the local evening news in Martinique. Yes, Dr. Samba speaks French, too!</p><br>
<br>
              ...
              <!-- span8 --> 
                ...
                <div class="skepost clearfix">
                  <iframe width="100%" height="315" src="https://www.youtube.com/embed/5e1UOS00IiE" frameborder="0" allowfullscreen></iframe>
                </div>
                <!-- skepost -->
...
<br>
          ...
          <span class="skepost clearfix"><br>
<br>
</span>
