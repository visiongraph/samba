...
<?php include 'topabout.php';?>
    ...
    <div class="container post-wrap" style="background-color:#FFF; padding:20px;">
      <div class="row-fluid">
            ...
            <div class="post clearfix post-146 skt_menu_items type-skt_menu_items status-publish has-post-thumbnail hentry menu_item_category-dessert" id="post-146">
              <div class="featured-image-shadow-box blog-menu-items span12" style="text-align:justify; font-size:14px;"> 
                ...
                <div class="skepost-meta clearfix centrado ">
                  <div class="menu-meta-left"><div><br> <h1 class="post-title"><i class="fa fa-users"></i>
 Team Leaders</h1><br>
          </div>
                  </div>
                </div>
            ...
            <div class="post clearfix post-144 skt_menu_items type-skt_menu_items status-publish has-post-thumbnail hentry menu_item_category-russian" id="post-144">
              <div class="featured-image-shadow-box blog-menu-items span4"> 
                <!-- normal -->
                <div class="fade_in_hide element_fade_in"> <a href="#"><span class="img"><img class="skin-border" src="images/about/philip.png" alt="Menu Thumbnail" /></span> <span class="info"> <span class="skt-info-back"> <span class="skt-external-link"></span>
                  <h3></h3>
                  </span> </span> </a> </div>
                <!-- end normal --> 
              </div>
              <div class="span8 fade_in_hide element_fade_in">
                <h1 class="post-title"><a href="#" title="Ricotta Pie">Philip Galinsky, Ph.D</a></h1>
                <div class="skepost-meta clearfix">
                  <div class="menu-meta-left"> Director<!-- rating --> 
                  </div>
                </div>
                <!-- skepost-meta -->
                
                <div class="skepost clearfix">
                  <p>A leading educator and performer of samba percussion in the US, and one of the foremost ethnomusicologists specializing in Brazilian music, Philip Galinsky founded Samba New York! in 2003 together with his wife, Valerie Galinsky, and is the group’s Director and principal percussionist.<br>
<br>


Conducting music research in Brazil since 1993, he has published widely in the field of ethnomusicology, including pioneering work on the pagode samba and mangue movements. He holds a Ph.D. in ethnomusicology from Wesleyan University, where his doctoral dissertation, <a href="https://www.routledge.com/products/9781138890800" target="_blank">Maracatu Atômico</a>, was selected for publication in Routledge’s Outstanding Dissertations series. He has taught ethnomusicology at Wesleyan University, UC Davis, and Hampshire College, also founding and directing samba ensembles at each of these schools.<br>
<br>


Having studied with such Brazilian master drummers as Jorge Alabê, Mestre Jonas, Mestre Odilon, Mestre Aílton, and Miguel do Repinique, he has performed since 1999 in the Rio Carnaval with some of the world’s most renowned samba schools, including Mocidade, Salgueiro, and Imperatriz — a rare honor for a non-Brazilian.
</p>
                </div>
              <!-- skepost --></div>
              <!-- span4 --> 
            ...
            <!-- post -->
            <div class="post clearfix post-104 skt_menu_items type-skt_menu_items status-publish has-post-thumbnail hentry menu_item_category-russian" id="post-104">
              <div class="featured-image-shadow-box blog-menu-items span4"> 
                <!-- normal -->
                <div class="fade_in_hide element_fade_in"> <a href="#"><span class="img"><img class="skin-border" src="images/about/valerie.png" alt="Menu Thumbnail" /></span> <span class="info"> <span class="skt-info-back"> <span class="skt-external-link"></span>
                  <h3></h3>
                  </span> </span> </a> </div>
                <!-- end normal --> 
              </div>
              <div class="span8 fade_in_hide element_fade_in">
                <h1 class="post-title"><a href="#" title="Donec vestibulum">Valerie Galinsky </a></h1>
                <div class="skepost-meta clearfix">
                  <div class="menu-meta-left"> <span class="author-post-rating-stars">Manager  </span><!-- rating --> 
                  </div>
                  <div class="menu-meta-right"></span></span></span> </div>
           </div>
                <!-- skepost-meta -->
                
                <div class="skepost clearfix">
                  <p>Valerie Galinsky is originally from the Caribbean island of Martinique. Having earned a college degree in Travel and Tourism from Johnson and Wales University in Rhode Island, she has been living in New York since 1995. Coming from a highly musical island with its own rich culture, she loves dance and music and has been passionate about samba since meeting her husband, Philip Galinsky. An essential part of Samba New York! from the beginning, she collaborated with Philip in the founding of the company in 2002-2003 and has been contributing her creative ideas and support ever since in all areas of the organization. As Manager of Samba New York, Valerie has helped the company’s shows become an industry standard in professionalism. She is appreciated by performers, students, and clients alike for her uplifting personality, her remarkable ability to make people feel a part of the Samba New York! community, and her impeccable organizational skills.<br>
<br>


Aside from her responsibilities in Samba New York, Valerie earned a certificate in health coaching from the Institute for Integrative Nutrition and runs an International Health Coaching practice in New York. She is fluent in French, English, Portuguese, Italian, and Spanish.
