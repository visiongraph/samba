...
<?php include 'topmedia.php';?>
  ...
  <source src="music/sambando.mp3" type="audio/mpeg" >
...
<p>Resume<br>
                ...
                <!-- skepost --></div>
           <div class="span4" >
                 <h2 >Bateria No Caminho </h2>
                <div class="skepost-meta clearfix">
                  <div class="menu-meta-left"> 
                                           
	   <div class="examples1">
		Music By Samba New York 2016 (edited)
  ...
  <source src="music/bateria.mp3" type="audio/mpeg" >
Your browser does not support the audio element.
</audio>
<p>Resume<br>
                </p>
            ...
            <div class="span4" >
                 <h2 >The Samba Dance </h2>
                <div class="skepost-meta clearfix">
                  <div class="menu-meta-left"> 
                                           
	   <div class="examples1">
		Music By Samba New York 2015 (edited)
  ...
  <source src="music/samba-dance.mp3" type="audio/mpeg" >
Your browser does not support the audio element.
</audio>
<p>Resume<br>
                </p>
                ...
                <div class="clear" style="height:40px;"></div>
                 <div class="span4" style="margin:0px" >
                 <h2 > The Samba Dance (no vocal)</h2>
                <div class="skepost-meta clearfix">
                  <div class="menu-meta-left"> 
  ...
  <source src="music/samba-dance-no.mp3" type="audio/mpeg" >
Your browser does not support the audio element.
</audio>
<p>Resume<br>
                </p>
  ...
  <source src="music/vem.mp3" type="audio/mpeg" >
Your browser does not support the audio element.
</audio>
<p>Resume<br>
                </p>
