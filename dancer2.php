...
<?php include 'topdancer.php';?>
  <div class="container post-wrap" style="background:#FFF; padding:20px;" >
            ...
            <div class="featured-image-shadow-box blog-menu-items span12" style="text-align:justify; font-size:14px;">
              <div class="skepost-meta clearfix centrado">
                <div class="menu-meta-left">
                  <div><br>
                    <h1 class="post-title"><i class="fa fa-female"></i> Dancers</h1>
                    <br>
                  </div>
                </div>
              </div>
   <div class="span3" style="margin:0px;">
	   ...
	   <div class="examples1">
		<a href="#" class="slvj-link-lightbox 1" data-videoid="K7-hs6hMCio" data-videosite="youtube">
			<i class="fa fa-video-camera" ></i> See Video Here 
		</a><br>
...
<p>
	...
	<script type="text/javascript">
		...
		$('.examples1 a').simpleLightboxVideo();
                ...
                <div class="skepost clearfix"> <img src="images/dancer/2.jpg" >
                  <p>
                  </p>
                </div>
                <!-- skepost --></div>
	...
	<script type="text/javascript">
		...
		$('.examples1 a').simpleLightboxVideo();
                ...
                <div class="skepost clearfix"> <img src="images/dancer/3.jpg" >
                  <p>
                  </p>
                </div>
                <!-- skepost --></div> <div class="span3">
                <h2 >Dancer 4</h2>
                <div class="skepost-meta clearfix">
                  <div class="menu-meta-left"> 
	...
	<script type="text/javascript">
		...
		$('.examples1 a').simpleLightboxVideo();
                ...
                <div class="skepost clearfix"> <img src="images/dancer/4.jpg" >
                  <p>
                  </p>
                </div>
                <!-- skepost --></div>
	...
	<script type="text/javascript">
		...
		$('.examples1 a').simpleLightboxVideo();
                ...
                <div class="skepost clearfix"> <img src="images/dancer/5.jpg" >
                  <p>
                  </p>
                </div>
                <!-- skepost --></div>
	...
	<script type="text/javascript">
		...
		$('.examples1 a').simpleLightboxVideo();
                ...
                <div class="skepost clearfix"> <img src="images/dancer/6.jpg" >
                  <p>
                  </p>
                </div>
                <!-- skepost --></div>
	...
	<script type="text/javascript">
		...
		$('.examples1 a').simpleLightboxVideo();
                ...
                <div class="skepost clearfix"> <img src="images/dancer/7.jpg" >
                  <p>
                  </p>
                </div>
                <!-- skepost --></div> <div class="span3">
	...
	<script type="text/javascript">
		...
		$('.examples1 a').simpleLightboxVideo();
                ...
                <div class="skepost clearfix"> <img src="images/dancer/8.jpg" >
                  <p>
                  </p>
                </div>
                <!-- skepost --></div> <div class="clear" style="height:40px;"></div>
                <div class="span3" style="margin:0px;">
                <h2 >Dancer 9</h2>
                <div class="skepost-meta clearfix">
                  <div class="menu-meta-left"> 
	...
	<script type="text/javascript">
		...
		$('.examples1 a').simpleLightboxVideo();
                ...
                <div class="skepost clearfix"> <img src="images/dancer/9.jpg" >
                  <p>
                  </p>
                </div>
                <!-- skepost --></div>
	...
	<script type="text/javascript">
		...
		$('.examples1 a').simpleLightboxVideo();
                ...
                <div class="skepost clearfix"> <img src="images/dancer/10.jpg" >
                  <p>
                  </p>
                </div>
                <!-- skepost --></div>
	...
	<script type="text/javascript">
		...
		$('.examples1 a').simpleLightboxVideo();
                ...
                <div class="skepost clearfix"> <img src="images/dancer/11.jpg" >
                  <p>
                  </p>
                </div>
                <!-- skepost --></div>
	...
	<script type="text/javascript">
		...
		$('.examples1 a').simpleLightboxVideo();
                ...
                <div class="skepost clearfix"><img src="images/dancer/12.jpg" >
                  <p>
                </p>
                </div>
                <!-- skepost --></div>
